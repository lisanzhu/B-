...
# Form implementation generated from reading ui file 'e:\360MoveData\Users\子嘿\Desktop\最终待用UI\UI文件\demo9.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form,tit,atr):
        ...
        self.titles=tit
        self.bPTree_article=atr

        self.retranslateUi(Form)
        QtCore.QMetaObject.connectSlotsByName(Form)
        for n in range(len(self.titles)):
            for i in self.bPTree_article.search(self.titles[n], self.titles[n]):
                dic=final_read.getContent(i.value)
